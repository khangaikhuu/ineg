...
public class MSkillCategory implements Serializable {
    ...
    @Column(name = "name")
    private String name;
    @OneToMany(mappedBy = "skillCategoryId")
    private List<MStaff> mStaffList;

    public MSkillCategory() {
    }

    public MSkillCategory(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MSkillCategory)) {
            return false;
        }
        MSkillCategory other = (MSkillCategory) object;
